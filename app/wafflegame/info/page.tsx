import { StandardLayout } from "@/app/layout";
        ...
        <StandardLayout>
            <div className="basic-card">
                ...
                <div className="p-4 text-l">
                    ...
                    Clicking a tile will change it to the next state in a repeating cyan magenta yellow cycle, but it will also cause any neighboring tiles to shift states in a similar way.
